...
if (count($_POST)>0){
	...
	if(!isset($_POST['Usuario'])) throw ("error altausuario 3");
	if(!isset($_POST['DNI'])) throw ("error altausuario 4");
	if(!isset($_POST['Telefono'])) throw ("error altausuario 5");
	if(!isset($_POST['Direccion'])) throw ("error altausuario 6");
	if(!isset($_POST['Contrasenia'])) throw ("error altausuario 7");
	if(!isset($_POST['Contrasenia2'])) throw ("error altausuario 8");
